...
@Composable
fun LoginScreen(
    onLoginClicked: (String, String, (Boolean, String?) -> Unit) -> Unit,
...
//    )
    ...
    val isFormValid = email.length >= 10 && password.isNotEmpty()
            ...
            OutlinedTextField(
                ...
                trailingIcon = {
                    IconButton(onClick = { showPassword = !showPassword }) {
                        val icon = if (showPassword) painterResource(id = R.drawable.password_2_off_24px) else painterResource(id = R.drawable.password_2_24px)
